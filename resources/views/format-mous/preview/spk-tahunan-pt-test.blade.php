...
<body>
    ...
    <!-- Footer removed, handled by script -->
    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <p>Pada hari ini {{ \Carbon\Carbon::parse($mou->start_date)->locale('id')->translatedFormat('l') }}, tanggal
                {{ \Carbon\Carbon::parse($mou->start_date)->locale('id')->translatedFormat('d F Y') }} pihak Pertama dan
                pihak Kedua sepakat untuk mengadakan <strong>Perikatan Jasa Konsultasi Perpajakan Atas Pekerjaan
                    Konsultasi Kewajiban Perpajakan {{ $mou->client->company_name }} Untuk Tahun Yang Berakhir
        ...
        <div class="section">
            ...
            <p>Tujuan perikatan jasa supervisi kewajiban perpajakan ini adalah, Pihak Kedua dapat membantu Pihak Pertama
                dalam supervisi dan penyusunan kewajiban perpajakan sesuai dengan UU KUP Perpajakan yang berlaku di
                Indonesia.</p>
            <p>Ruang lingkup surat perikatan jasa ini meliputi kegiatan untuk melakukan pekerjaan supervisi kewajiban
                perpajakan Pihak Pertama, berdasarkan data – data yang kami terima dari Pihak Pertama yang dapat
                dipertanggung jawabkan sesuai dengan peraturan perundang - undangan dan ketentuan umum perpajakan yang
                berlaku di Indonesia.</p>
        </div>

        <div class="section">
            <div class="section-title">Prosedur Pelaksanaan</div>
            <p>Untuk kelancaran dan dapat dilaksanakannya pekerjaan jasa tersebut di atas, maka pihak Pertama wajib
                memberikan informasi, data/dokumen-dokumen secara tertulis atau melalui email yang diperlukan oleh pihak
                Kedua baik berupa rekap maupun bukti transaksi. Data diberikan oleh pihak Pertama sendiri atau pegawai
                Pihak Pertama yang telah mendapatkan wewenang dari Pihak Pertama, untuk mewakili Pihak Pertama dalam hal
                pemberian data/dokumen yang diperlukan oleh Pihak kedua.</p>
            ...
            <!-- Ensure page break doesn't split procedures badly -->
            ...
            <p>Pihak Kedua tidak bertanggung jawab atas ketidaksesuaian data/dokumen yang diberikan oleh pihak Pertama
                dengan kondisi riil maupun kondisi temuan data dari pihak KPP atas kewajiban perpajakan yang
                bertentangan dengan ketentuan hukum, serta ketentuan dan peraturan perpajakan.</p>
        </div>

        <!-- Force Page Break if needed, or let content flow -->
        <div style="page-break-inside: avoid;">
            <div class="section">
                <div class="section-title">Fee Jasa Pekerjaan</div>
                <p>Jasa Profesional yang kami bebankan untuk pekerjaan supervisi laporan keuangan seperti tersebut di
                    atas adalah sebagai berikut:</p>
                    ...
                    <tbody>
                        @foreach ($costLists as $i => $cost)
                            <tr>
                                ...
                                <td style="text-align: right;">Rp {{ number_format($cost->total_amount, 0, ',', '.') }}
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="section">
            ...
            <p>Jangka waktu pelaksanaan pekerjaan adalah sejak perikatan kerjasama ini ditandatangani oleh kedua belah
                pihak, sampai dengan bulan Januari
                {{ \Carbon\Carbon::parse($mou->end_date)->addYear()->locale('id')->translatedFormat('Y') }}.</p>
        </div>

        <div class="section">
            <div class="section-title">Penarikan Diri</div>
            <p>Pihak Kedua akan menarik diri dari penugasan ini bilamana terdapat perbedaan yang sangat prinsipil dan
                tidak terselesaikan dengan Pihak Pertama.</p>
        </div>
