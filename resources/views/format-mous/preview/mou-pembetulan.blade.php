...
<body>
    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <p>Pada hari ini {{ \Carbon\Carbon::parse($mou->start_date)->locale('id')->translatedFormat('l') }},
                tanggal {{ \Carbon\Carbon::parse($mou->start_date)->locale('id')->translatedFormat('d F Y') }}
        ...
        <div class="section">
            ...
            <p>Tujuan Surat Perjanjian Kompilasi atas Pembetulan SPT ini adalah, Pihak Kedua dapat
                membantu Pihak Pertama dalam penyusunan pembetulan SPT sesuai dengan UU KUP
                Perpajakan yang berlaku di Indonesia.</p>

            <p>Ruang lingkup surat perikatan jasa ini meliputi kegiatan untuk melakukan pekerjaan
                supervisi kewajiban perpajakan dan kompilasi Pembetulan SPT Pihak Pertama,
                berdasarkan data – data yang kami terima dari Pihak Pertama yang dapat dipertanggung
                jawabkan sesuai dengan peraturan perundang - undangan dan ketentuan umum perpajakan
