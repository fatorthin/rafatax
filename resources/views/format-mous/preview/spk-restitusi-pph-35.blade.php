...
<head>
    ...
    <title>Surat Perjanjian Kerja Restitusi PPH 35 -
        ...
        <div class="section">
            ...
            <div class="parties">
                <div class="party">
                    ...
                    <p style="margin:0;"><strong>{{ $mou->client->owner_role ?: 'OWNER' }}</strong> </p>
        ...
        <script type="text/php">
            if (isset($pdf)) {
                $pdf->page_script('
                    ...
                    // Determine footer image based on MOU type
                    // In Original blade it uses logic: type == "pt" ? footer-v1 : footer-kkp
                    // For preview we can replicate this, potentially with page numbers if requested, 
                    // but for now strict replication of original image logic is safest.
                    // However, standard PDF previews usually use the v1/v3 logic for PT multi-page documents.
                    // Given this is a legal document that spans pages, I will apply v1/v3 for PT and kkp for KKP.
