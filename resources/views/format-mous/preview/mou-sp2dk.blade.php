...
<head>
    ...
    <title>Surat Perjanjian Kompilasi SP2DK -
...
<body>
    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="document-subtitle">Atas SP2DK TAHUN
                {{ \Carbon\Carbon::parse($mou->start_date)->format('Y') }}</div>
        ...
        <div class="section">
            ...
            <p>Tujuan Surat Perjanjian Kompilasi atas Pembetulan SP2DK ini adalah, Pihak Kedua dapat
                membantu Pihak Pertama dalam kompilasi SP2DK sesuai dengan UU KUP Perpajakan yang
                berlaku di Indonesia.</p>

            <p>Ruang lingkup surat perikatan jasa ini meliputi kegiatan untuk melakukan pekerjaan
                supervisi kewajiban perpajakan dan kompilasi SP2DK Pihak Pertama, berdasarkan data –
                data yang kami terima dari Pihak Pertama yang dapat dipertanggung jawabkan sesuai
                dengan peraturan perundang - undangan dan ketentuan umum perpajakan yang berlaku di
                Indonesia.</p>
        </div>
        ...
        <div class="section" style="page-break-inside: avoid;">
            ...
            <p><em>Fee belum termasuk PPh yang harus dipotong, dengan rincian pembayaran 10% dari
                    nominal yang disepakati setelah perjanjian ini di tandatangani dan sisa nya akan
                    di bayarkan setelah pembetulan terlapor.</em></p>
        </div>

        <div class="section">
            <div class="section-title">Jangka Waktu</div>
            <p>Jangka waktu pelaksanaan pekerjaan adalah sejak perikatan kerjasama ini
                ditandatangani oleh kedua belah pihak, sampai <b>dengan selesainya SP2DK</b>.</p>
        </div>
        ...
        <div class="section">
            ...
            <p>Lingkup pekerjaan hanya terkait dengan kompilasi penyusunan SP2DK sebagaimana disebut
                dalam <strong>rincian pekerjaan</strong> dan <strong>tidak termasuk pemeriksaan,
