...
<body>
    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="document-subtitle">ATAS PENDAMPINGAN PEMERIKSAAN</div>
            <div class="document-subtitle">Tahun Pajak
        ...
        <div class="section">
            ...
            <p>Pada hari ini
                ...
                diatur dalam pasal-pasal Surat Perjanjian atas Pendampingan Pemeriksaan atas nama
                {{ $mou->client->company_name ?? '-' }} tahun pajak
                {{ $mou->tahun_pajak ?? \Carbon\Carbon::parse($mou->end_date)->locale('id')->translatedFormat('Y') }}
                di
                bawah ini:</p>
        </div>
        ...
        <div class="section">
            ...
            <p>Tujuan Surat Perjanjian Kompilasi atas Pendampingan Pemeriksaan Tahun
                {{ $mou->tahun_pajak ?? \Carbon\Carbon::parse($mou->end_date)->locale('id')->translatedFormat('Y') }}
                ini adalah, Pihak Kedua dapat membantu Pihak Pertama dalam pendampingan pemeriksaan
                tahun
                {{ $mou->tahun_pajak ?? \Carbon\Carbon::parse($mou->end_date)->locale('id')->translatedFormat('Y') }}
                sesuai dengan UU KUP Perpajakan yang berlaku di Indonesia.</p>

            <p>Ruang lingkup surat perikatan jasa ini meliputi kegiatan untuk melakukan pekerjaan
                supervisi kewajiban perpajakan dan pendampingan pemeriksaan tahun
                {{ $mou->tahun_pajak ?? \Carbon\Carbon::parse($mou->end_date)->locale('id')->translatedFormat('Y') }}
                Pihak Pertama, berdasarkan data – data yang kami terima dari Pihak Pertama yang
                dapat dipertanggung jawabkan sesuai dengan peraturan perundang - undangan dan
                ketentuan umum perpajakan yang berlaku di Indonesia.</p>
        </div>
        ...
        <div class="section">
            ...
            <ol>
                <li>Penyusunan Persiapan Pemeriksaan Tahun
                    {{ $mou->tahun_pajak ?? \Carbon\Carbon::parse($mou->end_date)->locale('id')->translatedFormat('Y') }}.
                </li>
                <li>Konsultasi Perpajakan terkait tahun pajak
                    {{ $mou->tahun_pajak ?? \Carbon\Carbon::parse($mou->end_date)->locale('id')->translatedFormat('Y') }}.
                </li>
                <li>Pendampingan Pemeriksaan Tahun
                    {{ $mou->tahun_pajak ?? \Carbon\Carbon::parse($mou->end_date)->locale('id')->translatedFormat('Y') }}.
                </li>
            </ol>
            ...
            <div style="page-break-inside: avoid;">
                ...
                <ol>
                    ...
                    <li>Penyusunan Persiapan Pemeriksaan Tahun Pajak
                        {{ $mou->tahun_pajak ?? \Carbon\Carbon::parse($mou->end_date)->locale('id')->translatedFormat('Y') }}.
                    </li>
                </ol>
            </div>
            ...
            <div style="page-break-inside: avoid;">
                ...
                <ol>
                    <li>Review dalam bentuk resume kewajiban perpajakan Pihak Pertama yang telah
                        berjalan.</li>
                    <li>SPHP Pemeriksaan Tahun Pajak
                        {{ $mou->tahun_pajak ?? \Carbon\Carbon::parse($mou->end_date)->locale('id')->translatedFormat('Y') }}.
                    </li>
                </ol>
            </div>
