            ...
            <tr>
                <td>
                    <div class="container">
                        ...
                        <header class="header">
                            <p class="document-title">SURAT PERIKATAN JASA</p>
                            <p class="document-subtitle">LAPORAN KEUANGAN SINKRONISASI AUDIT TAHUN {{ $mou->tahun_pajak }}</p>
                        ...
                        <div class="content">
                            <div class="section">
                                ...
                                <p>Pada hari ini
                                    ...
                                    pihak Pertama dan pihak Kedua sepakat untuk mengadakan perjanjian kerja sama
                                    Penyusunan Laporan Keuangan untuk Audit Tahun {{ $mou->tahun_pajak ?? \Carbon\Carbon::parse($mou->end_date)->locale('id')->translatedFormat('Y') }} {{ $mou->client->company_name ?? '-' }} seperti diatur dalam pasal-pasal Surat Perikatan Jasa Supervisi Laporan Keuangan di bawah ini :</p>
                            </div>
                            ...
                            <div class="section">
                                ...
                                <p>Lingkup pekerjaan hanya terkait dengan segala jasa supervisi laporan keuangan tahun pajak {{ $mou->tahun_pajak ?? \Carbon\Carbon::parse($mou->end_date)->locale('id')->translatedFormat('Y') }}, sebagaimana tersebut dalam Prosedur pelaksanaan. Adapun jika terdapat pekerjaan di Luar selain tersebut, akan di kenakan Fee tersendiri dan dibuatkan kontrak  secara tertulis dan terpisah dari surat perjanjian kerja sama ini.
                                </p>
                            </div>
