                        ...
                        <div class="content">
                            ...
                            <div class="section">
                                ...
                                <p>Pihak Kedua tidak bertanggung jawab atas ketidaksesuaian data/dokumen yang diberikan
                                    ...
                                    atas kewajiban perpajakan TAHUN 2025 yang bertentangan dengan ketentuan hukum, serta
                                    ketentuan dan peraturan perpajakan. Pihak Kedua juga dibebaskan dari segala tuntutan
                                    hukum atas penyalahgunaan data/dokumen/laporan oleh pihak ketiga maupun informasi
                                    yang tidak lengkap yang diperoleh dari pihak Pertama.</p>
                            </div>
                            ...
                            <div class="section">
                                ...
                                <p><em>Fee belum termasuk PPh yang harus dipotong, dengan rincian pembayaran yang di
                                        ...
                                        sampai dengan masa
                                        pajak Desember
                                        {{ $mou->tahun_pajak ?? \Carbon\Carbon::parse($mou->end_date)->locale('id')->translatedFormat('Y') }}</em>
                                </p>
                            </div>
                            ...
                            <div class="section">
                                ...
                                <p>Jangka waktu pelaksanaan pekerjaan adalah sejak perikatan kerjasama ini
                                    ditandatangani oleh kedua belah pihak, sampai dengan bulan @if ($mou->categoryMou->id == 1)
                                        April
                                        {{ ($mou->tahun_pajak ?? \Carbon\Carbon::parse($mou->end_date)->year) + 1 }}
                            ...
                            <div class="section">
                                ...
                                <p>Lingkup pekerjaan hanya terkait dengan kewajiban perpajakan tahun pajak
                                    ...
                                    <strong>tidak termasuk SP2DK, pemeriksaan, pengurusan restitusi</strong>,
                                    <strong>ataupun pekerjaan yang lain</strong>. Adapun jika terdapat pekerjaan di
                                    luar rinian pekerjaan, <strong>akan di kenakan Fee tersendiri dan dibuatkan
