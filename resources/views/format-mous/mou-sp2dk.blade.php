                        ...
                        <div class="content">
                            ...
                            <div class="section">
                                ...
                                <ol>
                                    ...
                                    <li>Penyusunan SP2DK {{ $mou->client->company_name }}  tahun pajak {{ \Carbon\Carbon::parse($mou->start_date)->format('Y') }}.</li>
                                </ol>
