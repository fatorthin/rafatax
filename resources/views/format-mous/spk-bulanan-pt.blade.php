                        ...
                        <div class="content">
                            <div class="section">
                                ...
                                <table class="parties-table">
                                 ...
                                 <p>Pada hari ini {{ \Carbon\Carbon::parse($mou->start_date)->locale('id')->translatedFormat('l') }}, tanggal {{ \Carbon\Carbon::parse($mou->start_date)->locale('id')->translatedFormat('d F Y') }} pihak Pertama dan pihak Kedua sepakat untuk mengadakan <strong>Perikatan Jasa Konsultasi Perpajakan Atas Pekerjaan Konsultasi Kewajiban Perpajakan {{ $mou->client->company_name }} Untuk Tahun Yang Berakhir {{ \Carbon\Carbon::parse($mou->end_date)->locale('id')->translatedFormat('d F Y') }}</strong>, seperti diatur dalam pasal-pasal Surat Perikatan di bawah ini:</p>
                            </div>
                            ...
                            <div class="section">
                                ...
                                <p><em>Fee belum termasuk PPh yang harus dipotong, dengan rincian pembayaran yang di sepakati akan di bayarkan setiap bulan berjalan mulai masa pajak {{ \Carbon\Carbon::parse($mou->start_date)->format('Y') }} sampai dengan masa pajak {{ \Carbon\Carbon::parse($mou->end_date)->format('Y') }}</em></p>
                            </div>
