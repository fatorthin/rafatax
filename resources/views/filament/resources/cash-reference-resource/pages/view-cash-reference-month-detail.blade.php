...
$prevBalance = \App\Models\CashReport::where('cash_reference_id', $record->id)->where('transaction_date', '<=', $lastDayPrevMonth)->sum(\Illuminate\Support\Facades\DB::raw('debit_amount - credit_amount'));
    @endphp
