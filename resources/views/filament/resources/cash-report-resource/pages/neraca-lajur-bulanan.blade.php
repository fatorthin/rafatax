<x-filament-panels::page>
        ...
        <div class="shadow rounded-lg overflow-hidden">
            @php
                ...
                foreach($data as $row) {
                    ...
                    // Calculate Neraca
                    $showInNeraca = preg_match('/^AO-(([1-2][0-9]{2}|30[0-5])(\.[1-5])?|(10[1-2])\.[1-5]|1010|1011)$/', $row->code);
                    ...
                    // Calculate Laba Rugi
                    $showInLabaRugi = preg_match('/^AO-(4[0-9]{2}(\.[1-6])?|501(\.[1-4])?|50[0-9]|5[1-9][0-9]|6[0-9]{2}|70[0-2])$/', $row->code);
    ...
    <style>
        @media print {
            .fi-page-header, .fi-sidebar, .fi-topbar {
