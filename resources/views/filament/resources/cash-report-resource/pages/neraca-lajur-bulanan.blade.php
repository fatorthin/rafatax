        ...
        <div class="shadow rounded-lg overflow-hidden">
            ...
            <div class="table-container">
                <table class="sticky-table">
                    <thead>
                        <tr>
                            <th class="sticky-col-1" rowspan="2">Kode Akun</th>
                    ...
                    <tbody>
                        ...
                        @foreach($data as $row)
                            @php
                                ...
                                $total = $neracaSetelahAJEDebit - $neracaSetelahAJEKredit;
                                ...
                                $showInNeraca = preg_match('/^AO-(([1-2][0-9]{2}|30[0-5])(\.[1-5])?|(10[1-2])\.[1-5])$/', $row->code);
                        ...
                        @endforeach
                        <tr class="total-row">
                            <td class="sticky-col-1">Total</td>
