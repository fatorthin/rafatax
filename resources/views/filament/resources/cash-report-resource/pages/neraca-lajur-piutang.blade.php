    ...
    <div class="space-y-6">
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="text-sm text-blue-800 dark:text-blue-200">
                    ...
                    <ul class="mt-1 list-disc pl-4 space-y-0.5">
                        <li><strong>Debit Piutang (AO-103) / Kredit AO-208 (Pendapatan Yang Belum Diterima)</strong>: Invoice dibuat pada bulan berjalan</li>
        ...
        <div 
            x-data="{
                ...
                syncScrollbar() {
                    const container = this.$refs.tableWrapper.querySelector('.table-container-piutang, .table-container, [class*=\'table-container\']');
                    if (!container) return;
        ...
        >
            ...
            <div x-ref="tableWrapper" class="shadow rounded-lg overflow-hidden">
                @php
