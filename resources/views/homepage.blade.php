...
<head>
    ...
    <meta name="author" content="Rafatax Consulting">
    ...
    <link rel="stylesheet" href="{{ asset('/css/homepage/fontawesome.css') }}">
    <link rel="stylesheet" href="{{ asset('/css/homepage/templatemo-finance-business.css') }}">
    <link rel="stylesheet" href="{{ asset('/css/homepage/owl.css') }}">
    <!--
...
<body>
            ...
            <div class="row">
                <div class="col-md-8 col-xs-12">
                    <ul class="left-info">
                        ...
                        <li><a href="#"><i class="fa fa-phone"></i>+6281359976015</a></li>
                    </ul>
                </div>
                <div class="col-md-4">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link external" href="/admin/login">Login</a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 align-self-center">
                                <div class="right-content">
                                    ...
                                    <p>Curabitur pulvinar sem a leo tempus facilisis. Sed non sagittis neque. Nulla conse quat tellus nibh, id molestie felis sagittis ut. Nam ullamcorper tempus ipsum in cursus<br><br>Praes end at dictum metus. Morbi id hendrerit lectus, nec dapibus ex. Etiam ipsum
                                        quam, luctus eu egestas eget, tincidunt</p>
                                    <a href="#" class="filled-button">Read More</a>
                                </div>
                            </div>
                        </div>
    ...
    <!-- Additional Scripts -->
    <script src="{{ asset('/js/homepage/jquery.singlePageNav.min.js') }}"></script>
    <script src="{{ asset('/js/homepage/custom.js') }}"></script>
    <script src="{{ asset('/js/homepage/owl.js') }}"></script>
    <script src="{{ asset('/js/homepage/slick.js') }}"></script>
    <script src="{{ asset('/js/homepage/accordions.js') }}"></script>
    <script>
        $(function() {
            // Single Page Nav
